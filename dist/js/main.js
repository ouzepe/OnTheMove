...
document.addEventListener("DOMContentLoaded", () => {
    ...
    map.on("click", (e) => {
        ...
        /* eslint-disable */ console.log(...oo_oo(`3342041870_253_4_255_5_4`, `📍 Coordonnées pour pinsData: x: ${x.toFixed(4)}, y: ${y.toFixed(4)}`));
    });
});
/* istanbul ignore next */ /* c8 ignore start */ /* eslint-disable */ ;
function oo_cm() { try {
